...
public class Search {
    ...
    ArrayList<String> performSearch(String query){
        ...
        //System.out.println("result from performSearch="+querySplit.size ());
       ...
       // System.out.println("result="+result);
        ...
        result.forEach ((k,v)->{
           // System.out.println (k+" : "+v);
            if(v==queryLength) {
//            	System.out.println("links-----"+k.getAbsolutePath());
//            	System.out.println(links.containsKey(new File(k.getAbsolutePath())));
            	if(links.get (new File (k.getAbsolutePath ()))!=null)
            	{
       ...
       // System.out.println("result links ="+resultLinks);
        return resultLinks;
    }
